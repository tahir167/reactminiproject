  ...
  return (
    <section className='bg-gray-100 h-auto lg:h-[70vh] flex flex-col items-center gap-15 py-8 lg:py-0'>
      <div className='flex flex-col gap-3 items-center mt-12'>
        <h1 className='font-bold text-black text-4xl text-center'>What Our Customers Say</h1>
        <p className='text-xl text-gray-500 text-center px-4'>Don't just take our word for it - hear from our satisfied customers.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-7 w-[90%] lg:w-[80%] mx-auto">

        <div className='flex flex-col w-[100%] h-auto sm:h-[35vh] shadow bg-white rounded-xl justify-center py-6 sm:py-0'>
          <div className='w-[80%] flex flex-col mx-auto gap-5'>
            ...
            <div className='flex gap-3'>
              <div className="w-12 h-12 rounded-full overflow-hidden">
                <img src="https://cdn-icons-png.flaticon.com/256/219/219969.png" alt="" className="w-full h-full object-cover" />
              </div>
              <div>
        ...
        <div className='flex flex-col w-[100%] h-auto sm:h-[35vh] shadow bg-white rounded-xl justify-center py-6 sm:py-0'>
          <div className='w-[80%] flex flex-col mx-auto gap-5'>
            ...
            <div className='flex gap-3'>
              <div className="w-12 h-12 rounded-full overflow-hidden">
                <img src="https://cdn-icons-png.flaticon.com/512/4086/4086679.png" alt="" className="w-full h-full object-cover" />
              </div>
              <div>
        ...
        <div className='flex flex-col w-[100%] h-auto sm:h-[35vh] shadow bg-white rounded-xl justify-center py-6 sm:py-0'>
          <div className='w-[80%] flex flex-col mx-auto gap-5'>
            ...
            <div className='flex gap-3'>
              <div className="w-12 h-12 rounded-full overflow-hidden">
                <img src="https://cdn1.iconfinder.com/data/icons/website-internet/48/website_-_female_user-512.png" alt="" className="w-full h-full object-cover" />
              </div>
              <div>
